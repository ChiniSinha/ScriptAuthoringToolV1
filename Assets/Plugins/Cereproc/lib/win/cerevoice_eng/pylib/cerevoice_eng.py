...
def abuf_to_string(*args):
  """abuf_to_string(CPRC_abuf * abuf) -> PyObject *"""
  return _cerevoice_eng.abuf_to_string(*args)
...
def CPRCEN_engine_load_voice(*args):
  """
    CPRCEN_engine_load_voice(CPRCEN_engine * eng, char const * licensef, char const * configf, char const * voicef, 
...
def CPRCEN_engine_load_voice_licensestr(*args):
  """
    CPRCEN_engine_load_voice_licensestr(CPRCEN_engine * eng, char const * license_text, char const * signature, char const * configf, 
        char const * voicef, enum CPRC_VOICE_LOAD_TYPE load_type) -> int
    """
...
def CPRCEN_engine_open_channel(*args):
  """
    CPRCEN_engine_open_channel(CPRCEN_engine * eng, char const * iso_language_code, char const * iso_region_code, 
        char const * voice_name, char const * srate) -> CPRCEN_channel_handle
    """
...
def CPRCEN_engine_channel_speak(*args):
  """
    CPRCEN_engine_channel_speak(CPRCEN_engine * eng, CPRCEN_channel_handle chan, char const * text, int textlen, 
        int flush) -> CPRC_abuf *
    """
...
def CPRCEN_engine_channel_force_append_to_file(*args):
  ...
  return _cerevoice_eng.CPRCEN_engine_channel_force_append_to_file(*args)
...
def CPRCEN_engine_open_channel_with_type(*args):
  """
    CPRCEN_engine_open_channel_with_type(CPRCEN_engine * eng, enum CPRCEN_CHANNEL_TYPE type, char const * iso_language_code, 
        char const * iso_region_code, char const * voice_code, char const * srate) -> CPRCEN_channel_handle
    """
...
def CPRCEN_engine_chan_text_process(*args):
  """
    CPRCEN_engine_chan_text_process(CPRCEN_engine * eng, CPRCEN_channel_handle chan, char const * text, int textlen, 
        int flush) -> char const *
    """
...
def CPRCEN_channel_get(*args):
  """CPRCEN_channel_get(CPRCEN_engine * eng, CPRCEN_channel_handle chan) -> CPRCEN_channel *"""
  return _cerevoice_eng.CPRCEN_channel_get(*args)

def CPRCEN_channel_fx(*args):
  """CPRCEN_channel_fx(CPRCEN_channel * c, char const * spurtxml)"""
  return _cerevoice_eng.CPRCEN_channel_fx(*args)
...
def CPRCEN_voice_synthtype(*args):
  """CPRCEN_voice_synthtype(CPRCEN_voice * v) -> enum CPRCEN_SYNTH_TYPE"""
  return _cerevoice_eng.CPRCEN_voice_synthtype(*args)

def CPRCEN_engine_channel_logger(*args):
  """CPRCEN_engine_channel_logger(CPRCEN_engine * eng, CPRCEN_channel_handle chan) -> CPTP_logger *"""
  return _cerevoice_eng.CPRCEN_engine_channel_logger(*args)

def CPRCEN_engine_channel_set_normaliser_tracing(*args):
  """CPRCEN_engine_channel_set_normaliser_tracing(CPRCEN_engine * eng, CPRCEN_channel_handle chan, int tracing)"""
  return _cerevoice_eng.CPRCEN_engine_channel_set_normaliser_tracing(*args)
